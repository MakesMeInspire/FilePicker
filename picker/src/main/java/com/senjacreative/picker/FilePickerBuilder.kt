...
import com.senjacreative.picker.models.sort.SortingTypes
...
class FilePickerBuilder {
    ...
    private fun start(context: Activity, requestCode: Int) {
        ...
        PickerManager.providerAuthorities = context.applicationContext.packageName + ".com.senjacreative.picker.provider"
    ...
    private fun start(fragment: Fragment, requestCode: Int) {
        fragment.context?.let {
            ...
            PickerManager.providerAuthorities = it.applicationContext?.packageName + ".com.senjacreative.picker.provider"
